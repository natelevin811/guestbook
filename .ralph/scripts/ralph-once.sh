...
After reviewing the results:
  ...
  - If issues: fix them, update .ralph/tasks/RALPH_TASK.md or guardrails, run again
EOF
}
...
main() {
  ...
  local task_file="$WORKSPACE/.ralph/tasks/RALPH_TASK.md"
  ...
  case "$signal" in
    ...
    "GUTTER")
      ...
      echo ""
      echo "Review .ralph/state/errors.log and consider:"
      echo "  1. Adding a guardrail to .ralph/state/guardrails.md"
  ...
  echo "  • cat .ralph/state/progress.md   # See progress log"
  echo ""
  echo "Next steps:"
